...
const introStyles = {
  ...
  crawlInner: { position: 'absolute', top: 0, left: '50%', width: 'min(720px, 86vw)', transform: 'rotateX(28deg) translateY(80vh)', transformOrigin: '50% 0%', marginLeft: 'calc(min(720px, 86vw) / -2)', textAlign: 'center', color: 'oklch(0.85 0.16 90)', textShadow: '0 0 12px oklch(0.85 0.16 90 / 0.5)', willChange: 'transform' },
  crawlEpisode: { fontFamily: 'Orbitron, sans-serif', fontWeight: 700, fontSize: 'clamp(18px, 3vw, 28px)', letterSpacing: 6, marginBottom: 28 },
  crawlTitle: { fontFamily: 'Orbitron, sans-serif', fontWeight: 900, fontSize: 'clamp(40px, 8vw, 80px)', letterSpacing: 3, lineHeight: 1.05, marginBottom: 64 },
  crawlBody: { fontFamily: 'Space Grotesk, sans-serif', fontWeight: 600, fontSize: 'clamp(20px, 2.6vw, 28px)', lineHeight: 1.55, textAlign: 'center' },
  ...
  return (
    <section style={heroStyles.wrap}>
      ...
      <p style={heroStyles.sub}>
        Pizza, glow-in-the-dark stuff, a movie, and a midnight mission.<br />
  ...
  return (
    <div style={lgStyles.scrim}>
      <div style={lgStyles.card}>
        ...
        <p style={lgStyles.body}>
          A classified invitation has been queued for delivery. Cabin lights will dim.
          Theme music will engage. Tap below to receive.
        </p>
        <button
